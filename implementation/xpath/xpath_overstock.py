...
items = [{'Title':allproducts[i][0],'ListPrice':allproducts[i][1],'Price':allproducts[i][2],'Saving':(allproducts[i][3])[0],'SavingPercent':(allproducts[i][3])[1].strip('()'),'Content':allproducts[i][4].replace('\n','')} for i in range(0,len(allproducts))]
